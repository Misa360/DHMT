...
void reshape(int w, int h) {
    ...
    switch(projectionMode) {
        case 1: myOrtho(-5, 5, -5, 5, 1, 20); printf("\n[Phep chieu Truc giao]"); break;
        case 2: myOblique(-5, 5, -5, 5, 1, 20); printf("\n[Phep chieu Xien]"); break;
        case 3: myFrustum(-1, 1, -1, 1, 1.5, 20); printf("\n[Phep chieu Phoi canh (Frustum)]"); break;
        case 4: myPerspective(45, (double)w/h, 1, 20); printf("\n[Phep chieu Phoi canh (Perspective)]"); break;
    }
